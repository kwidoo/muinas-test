...
/**
 * Class MuinasPypapplicationcostsproposalfile
 * 
 ...
 * @package App\Models
 */
class MuinasPypapplicationcostsproposalfile extends Model
{
	protected $table = 'muinas_pypapplicationcostsproposalfile';

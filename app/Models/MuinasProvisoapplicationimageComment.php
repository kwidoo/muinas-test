...
/**
 * Class MuinasProvisoapplicationimageComment
 * 
 ...
 * @package App\Models
 */
class MuinasProvisoapplicationimageComment extends Model
{
	protected $table = 'muinas_provisoapplicationimage_comment';
